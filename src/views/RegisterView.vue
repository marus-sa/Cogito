...
const form = reactive({ firstName: '', lastName: '', email: '', password: '', confirm: '', consent: false, grade: '7', subject: 'Математика', days: 'Пн, Ср', time: 'После 17:00', about: '', child: '', direction: 'Образовательное направление', tutors: '' })
const error = ref('')
